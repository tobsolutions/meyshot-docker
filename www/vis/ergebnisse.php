...
$sql = 'SELECT Nachname, Vorname, TotalRing, MAX(TotalRing01) FROM Scheiben WHERE Nachname <> "" AND Zeitstempel > "' . Date("Y-m-d")  . '" ORDER BY Nachname ASC, Vorname ASC, TotalRing01 DESC LIMIT 50';
